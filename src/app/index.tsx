...
import SvgIcon, { TSvgIconProps } from "@/components/SvgIcon/SvgIcon";
...
const Icon = memo(forwardRef<Svg, TSvgIconProps>((props, ref) => <SvgIcon ref={ref} viewBox="0 0 24 24" {...props}>
<Path
  fillRule="evenodd"
  clipRule="evenodd"
