...
const Tooltip = (props: IPopoverProps) => {
  ...
  if (!isTriggerElement && !isTriggerRef) {
    console.warn(`Tooltip: Invalid 'trigger' prop received, please pass a valid ReactElement or a Ref`);
  }
  ...
  return (
    <>
      ...
      >
        <Popper {...props} onClose={handleClose} triggerRef={triggerRef} contentProps={contentProps} />
      </Overlay>
    </>
  );
};
