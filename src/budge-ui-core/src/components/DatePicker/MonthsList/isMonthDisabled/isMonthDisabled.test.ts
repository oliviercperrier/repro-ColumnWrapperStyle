...
describe("test isMonthDisabled", () => {
  ...
  it("correctly detects valid dates withing minDate and maxDate boundaries", () => {
    expect(isMonthDisabled(new Date(2022, 1, 3), new Date(2020, 1, 3), new Date(2023, 2, 3))).toBe(false);
    expect(isMonthDisabled(new Date(2019, 1, 3), new Date(2020, 1, 3), new Date(2023, 2, 3))).toBe(true);
    expect(isMonthDisabled(new Date(2024, 1, 3), new Date(2020, 1, 3), new Date(2023, 2, 3))).toBe(true);
  });
});
